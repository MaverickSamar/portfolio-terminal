...
const ShellContext = React.createContext<ShellContextType>({} as ShellContextType);
...
export const ShellProvider: React.FC<ShellProviderProps> = ({children}) => {
    ...
    const [lastCommandIndex, _setLastCommandIndex] = useState<number>(0);
    ...
    return(
        <ShellContext.Provider value = {{history, command, lastCommandIndex, setHistory, setCommand, setLastCommandIndex, execute, clearHistory,}}>
            {children}
