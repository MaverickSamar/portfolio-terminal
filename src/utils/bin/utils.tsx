...
export const vi = async (args: string[]): Promise<string> => {
  ...
  export const repo = async (args?: string[]): Promise<string> => {
    setTimeout(function () {
      window.open('https://github.com/MaverickSamar/portfolio-terminal', '_blank');
    }, 1000);
...
export const banner = (args?: string[]): string => {
 ...
 ______________,--._(___Y___)_,--.__________________
|               --'            --'                  |                        
|  ████████╗████████╗███████═╗███████═╗██═╗  ██╗    |
|  ╚══██╔══╝██╔═════╝██║   ██║██║   ██║ ██║ ██╔╝    |
|     ██║   ████████╗██║   ██║██║   ██║  ████╔╝     |
...
|     ██║   ████████╗███████╔╝███████╔╝   ██║       |
|     ╚═╝    ╚══════╝ ╚═════╝   ╚═════╝   ╚═╝       |
|___________________________________________________|v${packageJson.version}    
